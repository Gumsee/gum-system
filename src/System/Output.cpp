...
namespace Gum {
  ...
  void Output::log(const std::string& message)
  {
  ...
  void Output::fatal(const std::string& message)
  {
  ...
  void Output::info(const std::string& message, bool newline, bool brackets)
  {
      std::string outStr = "";
      if(newline)
      {
...
std::string Output::getOutputSpacing()
{
  return "              ";
}
